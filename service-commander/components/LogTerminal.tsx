...
import { X, RefreshCw, Pause, Play, Download, Terminal } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-5xl bg-[#0f172a] rounded-lg shadow-2xl border border-slate-700 flex flex-col h-[85vh] overflow-hidden">
                ...
                <div 
                    ...
                    className="flex-1 overflow-y-auto p-4 font-mono text-sm terminal-scrollbar relative"
                >
                    {logs ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-slate-500 gap-2">
                             {loading ? (
                                ...
                                <span>No logs available for this session.</span>
                             )}
                        </div>
                    )}
